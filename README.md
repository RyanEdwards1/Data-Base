...
* The forms for my enemy characters was only displaying the names  
...
* Testing every bit of code after it was executed
...
When I was creating the ERD I had to look at the user requirements and how I was going to fit It into my database. I also had to see how it was going to work with linking up the tables as well.  
